...
insert into notes(note, bookid) values('Коммент к белой гвардии', 1);
--insert into notes(note, bookid) values('Второй коммент к белой гвардии', 1);
insert into notes(note, bookid) values('Коммент к Полдню', 2);
