...
--insert into notes(note, book_id) values('Второй коммент к белой гвардии', 1);
insert into notes(note, book_id) values('Коммент к Полдню', 2);

insert into users(login, password, name, role) values ('admin', 'adminpassword', 'Admin No 1', 'ADMIN');
insert into users(login, password, name, role) values ('reader', 'readerpassword', 'Reader No 1', 'READER');