...
insert into users(login, password, name, role) values ('admin', 'admin', 'Admin No 1', 'ADMIN');
insert into users(login, password, name, role) values ('reader', 'reader', 'Reader No 1', 'READER');
insert into users(login, password, name, role) values ('manager', 'manager', 'Reader No 1', 'MANAGER');