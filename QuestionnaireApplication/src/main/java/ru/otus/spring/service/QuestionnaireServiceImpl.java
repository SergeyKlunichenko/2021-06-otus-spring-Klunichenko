...
public class QuestionnaireServiceImpl implements  QuestionnaireService{
    ...
    public void execute() {
        ...
        try {
            ioService.println(messageService.getMessage("messages.questions.title", user.getSurname(), user.getName()));
            ...
            ioService.println(messageService.getMessage("messages.questions.thank", user.getSurname(), user.getName()));
        } catch (Exception e){
